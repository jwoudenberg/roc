...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x3B, 0x61, 0x57, 0xF8, 0x21, 0xB3, 0x95, 0x7A, 0x7E, 0x53, 0x68, 0xE3, 0x17, 0xF7, 0x8F, 0x86,
        0x47, 0xAB, 0xE9, 0xBA, 0x44, 0xB1, 0x51, 0x89, 0x44, 0xA9, 0xD6, 0xAD, 0x61, 0xFD, 0x1E, 0x1C,
    };

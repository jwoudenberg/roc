...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x64, 0x30, 0x96, 0x5C, 0x74, 0xDB, 0xDA, 0x27, 0xAE, 0x6F, 0x22, 0x75, 0x75, 0x8B, 0x01, 0x03,
        0x08, 0xA1, 0x97, 0xE8, 0x59, 0x38, 0x53, 0xDD, 0xE8, 0x21, 0xE0, 0xDA, 0xF9, 0xD2, 0x92, 0x4B,
    };
